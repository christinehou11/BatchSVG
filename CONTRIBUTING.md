...
This outlines how to propose a change to BatchSVG. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("christinehou11/BatchSVG", fork = TRUE)`.
...
Code of
Conduct](https://christinehou11.github.io/BatchSVG/CODE_OF_CONDUCT.md).
